...
- 📜 **Paper:** **Pengcheng Jiang**, Yu Xue, Ferrnate Neri, "Convolutional neural networks pruning based on multi-objective feature map selection for image classification,". *Applied Soft Computing* **(Submitted on Nov 23, 2022 \| SCI \| CAS 2st Region TOP (2022) \| JCR Q1 \| IF: 8.263)**[[Open PDF after acceptance]]()
- 📜 **Paper:** Yu Xue, **Pengcheng Jiang**, Ferrnate Neri, Ziming Yuan,"ConAM: Confidence Attention Module for Convolutional Neural Networks,". *IEEE Transactions on Image Processing* **(Submitted on Jan 18, 2023 \| SCI \| CAS 1st Region TOP (2022) \| JCR Q1 \| IF: 11.041)**[[Open PDF after acceptance]]()
