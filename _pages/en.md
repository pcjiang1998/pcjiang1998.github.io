...
- 📜 **Paper:** **Pengcheng Jiang**, Yu Xue, Ferrnate Neri, "Continuously evolving Dropout with multi-objective evolutionary optimization,". *Engineering Applications of Artificial Intelligence* **(Submitted on July 14 | 2022 | SCI | CAS 2st Region TOP (2021) | JCR Q1 | IF: 7.802)** [[Open PDF after acceptance]]()
- 📜 **Paper:** **Pengcheng Jiang**, Yu Xue, Jiayu Liang, Ujjwal Maulik, "FSplugin: A plugin for simplifying neural network classification based on feature scaling,". *IEEE Transactions on Neural Networks and Learning Systems* **(First review and revision | Trans | SCI | CAS 1st Region TOP (2021) | JCR Q1 | IF: 14.255)**[[Open PDF after acceptance]]()
- 📜 **Paper:** **Pengcheng Jiang**, Yu Xue, Ferrnate Neri, "Convolutional neural networks pruning based on multi-objective feature map selection for image classification,". *Knowledge-Based Systems* **(First review and revision | SCI | CAS 1st Region TOP (2021) | JCR Q1 | IF: 8.139)**[[Open PDF after acceptance]]()
