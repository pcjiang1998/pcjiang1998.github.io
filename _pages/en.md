...
- 📜 **Paper:** Yu Xue, **Pengcheng Jiang**, Ferrnate Neri, Jiayu Liang, "A multi-objective evolutionary approach based on Graph-in-Graph for neural architecture search of convolutional neural networks,". *International Journal of Neural Systems*, vol. 31, no. 09, p. 2150035, 2021, [DOI: 10.1142/S0129065721500350](https://doi.org/10.1142/S0129065721500350). **(First author except teacher \| SCI \| CAS 1st Region TOP (2021) \| JCR Q1 \| IF: 6.325 \| Cited: 42)**[[Download PDF]](http://test2.jiangpengcheng.top/s0129065721500350.pdf)
- 📜 **Paper:** **Pengcheng Jiang**, Yu Xue, Ferrnate Neri, "Continuously evolving Dropout with multi-objective evolutionary optimization,". *Engineering Applications of Artificial Intelligence* **(First review and revision on Oct 28, 2022 \| 2022 \| SCI \| CAS 2st Region TOP (2021) \| JCR Q1 \| IF: 7.802)** [[Open PDF after acceptance]]()
- 📜 **Paper:** **Pengcheng Jiang**, Yu Xue, Jiayu Liang, Ujjwal Maulik, "FSplugin: A plugin for simplifying neural network classification based on feature scaling,". *IEEE Transactions on Neural Networks and Learning Systems* **(First review and revision on Sept 23, 2022 \| Trans \| SCI \| CAS 1st Region TOP (2021) \| JCR Q1 \| IF: 14.255)**[[Open PDF after acceptance]]()
- 📜 **Paper:** **Pengcheng Jiang**, Yu Xue, Ferrnate Neri, "Convolutional neural networks pruning based on multi-objective feature map selection for image classification,". *Knowledge-Based Systems* **(Second review on Nov 8, 2022 \| SCI \| CAS 1st Region TOP (2021) \| JCR Q1 \| IF: 8.139)**[[Open PDF after acceptance]]()
- 📜 **Paper:** **Pengcheng Jiang**, Yu Xue, "A distributed secret sharing method with QR code based on information hiding,". *Journal of Cyber Security*, vol. 3, no.4, pp. 217-225, 2021, [DOI: 10.32604/jcs.2021.026022](https://doi.org/10.32604/jcs.2021.026022). **(English Publications)** [[Download PDF]](http://test2.jiangpengcheng.top/03.pdf)
- 📰 **Software (ZH):** 安全二维码生成系统V1.0（2021SR0885987）
- 📜 **Paper (ZH):** **蒋鹏程**,熊礼治,韩啸.一种基于内容保护与优化识别的二维码方案[J].*软件导刊*,2019,18(02):119-122. **(SCD)** [[Download PDF]](http://test2.jiangpengcheng.top/02.pdf) [[CNKI Link]](https://chn.oversea.cnki.net/KCMS/detail/detail.aspx?sfield=fn&QueryID=0&CurRec=1&recid=&FileName=RJDK201902031&DbName=CJFDLAST2019)
- 📜 **Paper (ZH):** 韩啸,熊礼治,**蒋鹏程**,宋婷婷.一种密文图像安全性评价方案[J].*计算机应用与软件*,2019(03):148-153. **(PKU \| SCD \| Cited: 4)** [[Download PDF]](http://test2.jiangpengcheng.top/01.pdf) [[CNKI Link]](https://chn.oversea.cnki.net/KCMS/detail/detail.aspx?sfield=fn&QueryID=12&CurRec=1&recid=&FileName=JYRJ201903029&DbName=CJFDLAST2019)
- 📑 **Patent (ZH):** 熊礼治,**蒋鹏程**,王乐,韩啸,汤琳俪,曹梦琦.一种基于精准定位和安全扫码的共享单车计费方法[P]. CN109242645A,2019-01-18. **(First author except teacher)** [[Download PDF]](http://test2.jiangpengcheng.top/00.pdf) [[CNKI Link]](https://chn.oversea.cnki.net/KCMS/detail/detail.aspx?sfield=fn&QueryID=33&CurRec=1&DBCode=SCPD&dbname=SCPD201901&filename=CN109242645A)
