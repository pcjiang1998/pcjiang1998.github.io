...
# 📝 Scientific Achievements (Updated on 2024/8/2)
### Under review/revision
- 📜 **Paper:** Yu Xue, **Pengcheng Jiang**, Zhenman Zhang, Mengchu Zhou,"Neural Architecture Search Based on a Surrogate Model with Similarity Measurement,". *IEEE Transactions on Cybernetics* **(Submited on Jul. 10, 2024 \| Trans \| SCI \| CAS Q1 (2024) \| JCR Q1 \| IF: 9.4)**[[Open PDF after acceptance]]()
- 📜 **Paper:** **Pengcheng Jiang**, Yu Xue, Ferrnate Neri,"Multi-objective Neural Architecture Search as Bilevel Optimisation: A Novel Surrogate Approach,". *IEEE Transactions on Evolutionary Computation* **(Submited on Jul. 29, 2024 \| Trans \| SCI \| CAS Q1 (2024) \| JCR Q1 \| IF: 14.3)**[[Open PDF after acceptance]]()
- 📜 **Paper:** **Pengcheng Jiang**, Yu Xue, Ferrnate Neri,"Score predictor-assisted evolutionary neural architecture search,". *IEEE Transactions on Emerging Topics in Computational Intelligence* **(Under major revision on Jul. 24, 2024 \| Trans \| SCI \| CAS Q3 (2024) \| JCR Q1 \| IF: 5.3)**[[Open PDF after acceptance]]()
<!--  - 📜 **Paper:** **Pengcheng Jiang**, Yu Xue, "Multi-objective Self-adaptive PSO for Classification in Intrusion Detection with High-dimensional, Unbalanced and Cost-sensitive Data,". *IEEE Transactions on Computational Social Systems* **(Revise on Mar. 6 2024 \| Trans \| SCI \| CAS Q2 \| JCR Q1 \| IF: 5)**[[Open PDF after acceptance]]()   -->
- 📜 **Paper (ZH):** **蒋鹏程**,薛羽.基于排序得分预测的演化神经架构搜索方法[J].*计算机学报* **(Under 3rd review on Jul. 1, 2024 \| CCF-A)**[[Open PDF after acceptance]]()
- 📜 **Paper:** **Pengcheng Jiang**, Ferrnate Neri, Yu Xue, Ujjwal Maulik, "A Generalised Attention Mechanism to Enhance the Accuracy Performance of Neural Networks,". *International Journal of Neural Systems* **(Submitted with major revision on Jul. 26, 2024 \| SCI \| CAS Q2 \| JCR Q1 \| IF: 6.6)**[[Open PDF after acceptance]]()
