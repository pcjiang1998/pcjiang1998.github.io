...
- 📜 **Paper:** **Pengcheng Jiang**, Yu Xue, Yong Zhang, Dunwei Gong, Peng Chen, Mohamed Wahib. Evolutionary neural architecture search based on pairwise surrogate model with architecture augmentation[J]. *IEEE Transactions on Neural Networks and Learning Systems*. **(Submited on Oct. 1, 2025)** ``Trans`` ``SCI`` ``JCR Q1`` ``IF：8.9`` ``CCF-B`` ``CAAI-A``
...
- 📜 **Paper:** Yu Xue(Supervisor), **Pengcheng Jiang**, Chenchen Zhu, Yong Zhang, Ran Cheng, Kaizhou Gao, Dunwei Gong. A multi-objective evolutionary algorithm based on bi-population with uniform sampling for neural architecture search[J]. *IEEE Transactions on Neural Networks and Learning Systems*. **(R1 Submited on Aug. 20, 2025)** ``Trans`` ``SCI`` ``JCR Q1`` ``IF：8.9`` ``CCF-B`` ``CAAI-A``
- 📜 **Paper：**Yu Xue(Supervisor), **Pengcheng Jiang**, Chenchen Zhu, MengChu Zhou, Mohamed Wahib, Moncef Gabbouj. A pairwise comparison relation-assisted multi-objective evolutionary neural architecture search method with multi-population mechanism[J]. *IEEE Transactions on Systems, Man and Cybernetics: Systems*. **(R5 Submited on Aug. 31, 2025)** [[Arxiv]](https://arxiv.org/abs/2407.15600) ``Trans`` ``SCI`` ``JCR Q1`` ``IF：8.7`` ``CCF-B`` ``CAAI-B`` ``Cited: 4``
...
### Published
- 📜 **Paper:** Yixia Zhang, Ferrante Neri, Xilu Wang, **Pengcheng Jiang**, Yu Xue. Evolutionary channel pruning for StyleGANs[C]. *International Journal of Neural Systems, 2025: 2550070. [DOI: 10.1142/S0129065725500704](https://doi.org/10.1142/S0129065725500704) [[Download PDF]](./files/paper/IJNS-yxzhang2025.pdf) 	``CAS Q1`` ``JCR Q1 (2025)`` ``IF: 6.4``
- 📜 **Paper:** **Pengcheng Jiang**, Yu Xue, Ferrante Neri. Homogeneous architecture augmentation and confidence prediction for evolutionary neural architecture search[C]. *2025 IEEE Congress on Evolutionary Computation*. Hangzhou, China: IEEE, 2025: 1-8. [DOI: 10.1109/CEC65147.2025.11043091](https://doi.org/10.1109/CEC65147.2025.11043091) [[Download PDF]](./files/paper/CEC-2025.pdf) 	``CAAI-C``
...
- 📜 **Paper:** **Pengcheng Jiang**, Yu Xue, Ferrante Neri, Mohamed Wahib. Surrogate-assisted evolutionary neural architecture search with isomorphic training and prediction[C]//*2024 International Conference on Intelligent Computing (ICIC)*. Tianjing, China: Springer Nature, 2024, 14863: 191–203. [DOI: 10.1007/978-981-97-5581-3_16](https://doi.org/10.1007/978-981-97-5581-3_16) [[Download PDF]](./files/paper/ICIC-2024.pdf) ``CCF-C`` ``Cited: 3``
