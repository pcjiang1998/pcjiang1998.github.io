...
- 📜 **论文：**Yu Xue, **Pengcheng Jiang**, Zhenman Zhang, Mengchu Zhou. Neural architecture search based on a surrogate model with similarity measurement[J]. *IEEE Transactions on Cybernetics* (2025年3月21日提交) [[录用后公开PDF]](#)<tag>除老师外一作</tag><tagh>Trans</tagh><tag>SCI</tag><tag>中科院一区TOP</tag><tag>JCR Q1</tag><tag>IF：9.4</tag><tag>CCF-B</tag>
