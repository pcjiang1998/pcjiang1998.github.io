...
- 📜 **论文：****Pengcheng Jiang**, Yu Xue, Yong Zhang, Dunwei Gong, Peng Chen, Mohamed Wahib. Evolutionary neural architecture search based on pairwise surrogate model with architecture augmentation. (修改中)
...
### 已发表/出版
- 📜 **论文：**Yixia Zhang, Ferrante Neri, Xilu Wang, **Pengcheng Jiang**, Yu Xue. Evolutionary channel pruning for StyleGANs[C]. *International Journal of Neural Systems*. (Accepted) ``SCI`` ``中科院一区TOP`` ``JCR Q1`` ``IF：6.4``
