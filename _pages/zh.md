...
# 📝 科研成果（更新于2025/5/14）
### 正在审理/修改
- 📜 **论文：****Pengcheng Jiang**, Yu Xue. A Siamese Graph Neural Network Surrogate Assisted Efficient Evolutionary Neural Architecture Search. (初稿中)
- 📜 **论文：****Pengcheng Jiang**, Yu Xue, Yong Zhang, Dunwei Gong, Peng Chen, Mohamed Wahib. Evolutionary Neural Architecture Search Based on Pairwise Surrogate Model with Architecture Augmentation[J]. *IEEE Transactions on Industrial Informatics*. (2025年5月13日提交) ``Trans`` ``SCI`` ``中科院一区TOP`` ``JCR Q1`` ``IF：11.7`` ``CCF-C``
- 📜 **论文：**Yu Xue(导师), **Pengcheng Jiang**, Zhenman Zhang, Mengchu Zhou. Neural architecture search based on a surrogate model with similarity measurement[J]. *IEEE Transactions on Cybernetics*. (2025年3月21日提交第四轮修改) ``Trans`` ``SCI`` ``中科院一区TOP`` ``JCR Q1`` ``IF：9.4`` ``CCF-B`` ``CAAI-A``
- 📜 **论文：****Pengcheng Jiang**, Yu Xue, Ferrante Neri, Yong Zhang, Dunwei Gong. Rank surrogate-assisted dual-level evolutionary multi-objective neural architecture search[J]. *IEEE Transactions on Cybernetics*. (2025年3月19日提交) ``Trans`` ``SCI`` ``中科院一区TOP`` ``JCR Q1`` ``IF：9.4`` ``CCF-B`` ``CAAI-A``
- 📜 **论文：**Yu Xue, Chenchen Zhu, **Pengcheng Jiang**. A Multi-objective Evolutionary Algorithm Based on Bi-population with Uniform Sampling for Neural Architecture Search[J]. *IEEE Transactions on Neural Networks and Learning Systems*. (2025年4月15日投稿) ``Trans`` ``SCI`` ``中科院一区TOP`` ``JCR Q1`` ``IF：10.2`` ``CCF-B`` ``CAAI-A``
- 📜 **论文：**Yu Xue, **Pengcheng Jiang**, Chenchen Zhu, MengChu Zhou, Mohamed Wahib, Moncef Gabbouj. A Pairwise Comparison Relation-assisted Multi-objective Evolutionary Neural Architecture Search Method with Multi-population Mechanism[J]. *IEEE Transactions on Systems, Man and Cybernetics: Systems*. (2025年5月11日提交第四轮修改) ``Trans`` ``SCI`` ``中科院一区TOP`` ``JCR Q1`` ``IF：8.6`` ``CCF-B`` ``CAAI-B``
- 📜 **论文：**Yixia Zhang, Ferrante Neri, Xilu Wang, **Pengcheng Jiang**. Evolutionary Channel Pruning for StyleGANs[C]. *28th European Conference on Artificial Intelligence*. (2025年4月16日投稿) ``CCF-B`` ``CAAI-B``
- 📜 **论文：****Pengcheng Jiang**, Yu Xue, Yandan Xu. Multi-objective self-adaptive PSO for classification in intrusion detection with high-dimensional, unbalanced and cost-sensitive data[J]. *Integrated Computer-Aided Engineering*. (2025年5月14日投稿) ``SCI`` ``中科院二区`` ``JCR Q1`` ``IF：5.8`` ``CAAI-C``

### 已发表/出版
- 📜 **论文：****Pengcheng Jiang**, Yu Xue, Ferrante Neri. Homogeneous architecture augmentation and confidence prediction for evolutionary neural architecture search[C]. *2025 IEEE Congress on Evolutionary Computation*, Accept (Oral). [[下载PDF]](#) ``国际会议`` ``CAAI-C``
- 📜 **论文：****Pengcheng Jiang**, Yu Xue, Ferrante Neri. Score predictor-assisted evolutionary neural architecture search[J]. *IEEE Transactions on Emerging Topics in Computational Intelligence*, 2025, Early Access. [DOI: 10.1109/TETCI.2025.3526179](https://doi.org/10.1109/TETCI.2025.3526179) [[下载PDF]](./files/paper/TETCI-2025.pdf) ``Trans`` ``SCI`` ``中科院二区`` ``JCR Q1`` ``IF：5.3`` ``CAAI-B`` ``被引1``
- 📜 **论文：****Pengcheng Jiang**, Ferrante Neri, Yu Xue, Ujjwal Maulik. A generalised attention mechanism to enhance the accuracy performance of neural networks[J]. *International Journal of Neural Systems*, 2024, 34(12): 2450063. [DOI: 10.1142/S0129065724500631](https://doi.org/10.1142/S0129065724500631) [[下载PDF]](./files/paper/IJNS-2024.pdf) ``SCI`` ``中科院二区`` ``JCR Q1`` ``IF2024：6.6`` ``CAAI-B`` ``被引2``
- 📜 **论文：****蒋鹏程**,薛羽.基于排序得分预测的演化神经架构搜索方法[J].*计算机学报*, 2024, 47(11), 2522-2535. [[下载PDF]](./files/paper/cjc-202411.pdf) ``中文核心`` ``CCF-A`` ``CAAI-A``
- 📜 **论文：****Pengcheng Jiang**, Yu Xue, Ferrante Neri, Mohamed Wahib. Surrogate-assisted evolutionary neural architecture search with isomorphic training and prediction[C]//*2024 International Conference on Intelligent Computing (ICIC)*. Tianjing, China: Springer Nature, 2024, 14863: 191–203. [DOI: 10.1007/978-981-97-5581-3_16](https://doi.org/10.1007/978-981-97-5581-3_16) [[下载PDF]](./files/paper/ICIC-2024.pdf) ``国际会议`` ``Oral`` ``CCF-C``
- 📜 **论文：****Pengcheng Jiang**, Yu Xue, Ferrante Neri. Continuously evolving dropout with multi-objective evolutionary optimisation[J]. *Engineering Applications of Artificial Intelligence*, 2023, 124: 106504. [DOI: 10.1016/j.engappai.2023.106504](https://doi.org/10.1016/j.engappai.2023.106504) [[下载PDF]](./files/paper/EAAI-2023.pdf) ``SCI`` ``中科院一区TOP`` ``JCR Q1`` ``IF2023：7.5`` ``被引10`` ``CCF-C`` ``CAAI-C``
- 📜 **论文：****Pengcheng Jiang**, Yu Xue, Ferrante Neri. Convolutional neural network pruning based on multi-objective feature map selection for image classification[J]. *Applied Soft Computing*, 2023: 110229. [DOI: 10.1016/j.asoc.2023.110229](https://doi.org/10.1016/j.asoc.2023.110229) [[下载PDF]](./files/paper/ASOC-2023.pdf) ``SCI`` ``中科院一区TOP`` ``JCR Q1`` ``IF2023：7.2`` ``被引35`` ``CAAI-C``
- 📜 **论文：**Yu Xue(导师), **Pengcheng Jiang**, Ferrante Neri, Jiayu Liang. A multi-objective evolutionary approach based on graph-in-graph for neural architecture search of convolutional neural networks[J]. *International Journal of Neural Systems*, 2021, 31(09): 2150035. [DOI: 10.1142/S0129065721500350](https://doi.org/10.1142/S0129065721500350) [[下载PDF]](./files/paper/IJNS-2021.pdf) ``SCI`` ``中科院二区`` ``JCR Q1`` ``IF2021：6.325`` ``被引110`` ``CAAI-B``
